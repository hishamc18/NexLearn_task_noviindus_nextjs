...
export default function Timer({ totalTime, onTimeUp, onTimeUpdate }: TimerProps) {
  ...
  return (
      <div className="text-[13px] w-fit px-2 py-1 text-white font-semibold rounded-sm bg-[#1C3141] text-center mb-4 flex items-center gap-2">
